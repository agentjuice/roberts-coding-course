...
| 02 | Loops, Conditions & Lists | Quiz game |
| 03 | Functions & Dictionaries | Contact book |
| 04 | Files & Error Handling | Save/load high scores |

### Connect 4 (Lessons 5–8)
Build a full Connect 4 game, step by step.

| Lesson | Topic | Project |
|--------|-------|---------|
| 05 | 2D Lists & Game Boards | Draw the board |
| 06 | Game Logic | Drop pieces & check wins |
| 07 | Intro to Pygame | Connect 4 with graphics |
| 08 | Polish & AI Opponent | Simple computer player |
...
| Lesson | Topic | Project |
|--------|-------|---------|
| 09 | Game Loop & Movement | Moving square |
| 10 | Collision Detection | Snake eats food |
| 11 | Growing the Snake | Full snake mechanics |
| 12 | Score & Speed | Difficulty scaling |
| 13 | Menus & Game States | Title screen, game over |

### Dungeon Crawler (Lessons 14–20)
...
├── assets/            ← game art & sounds (lessons 16+)
├── lessons/
│   ├── 01-the-basics/
