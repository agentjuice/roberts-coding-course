...
Then in Lessons 5 and 6, we switched to Pygame and things got messy again. All the event handling, animation, drawing, and win-checking are tangled together in one giant loop. Sound familiar?
