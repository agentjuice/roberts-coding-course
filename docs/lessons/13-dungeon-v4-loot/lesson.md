...
The full file builds on everything from lessons 10-12 (player, enemies, combat) and adds:
...
Our dungeon is just one room. In Lesson 14, we'll create **multiple rooms** connected by doors, with a minimap to track where you've been!
