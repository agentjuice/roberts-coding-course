# Lesson 5: Connect 4 v1 -- Terminal Edition
...
Remember lists from Lesson 4? A list is like a row of boxes. But a Connect 4 board isn't just one row -- it's a **grid** with rows *and* columns. That's called a **2D array** (two-dimensional array). Think of it like a spreadsheet, or better yet, like graph paper where each square can hold a value.
