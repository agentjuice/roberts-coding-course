...
Our game works, but everything is colored squares. In Lesson 18, we'll replace them with **actual sprites and pixel art** to make the game look like a real dungeon crawler!
