...
- **Room 4** (Boss Room): Big empty room. No enemies yet — this is where the boss will go in Lesson 15!
...
This lesson builds on everything from Lesson 13:
...
Room 4 is suspiciously empty... In Lesson 15, we'll fill it with a **boss fight** complete with attack phases and a victory screen!
