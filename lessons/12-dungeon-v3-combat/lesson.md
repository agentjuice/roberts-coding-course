...
Everything from Lessons 10 and 11 is still here. Here's what we're adding.
...
In Lesson 13, we'll add loot drops — enemies will drop health potions and coins when they die, and we'll build an inventory to hold them.
